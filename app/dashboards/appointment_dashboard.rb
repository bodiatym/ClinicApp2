...
class AppointmentDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    doctor_profile: Field::BelongsTo.with_options(class_name: 'Profiles::DoctorProfile'),
    patient_profile: Field::BelongsTo.with_options(class_name: 'Profiles::PatientProfile'),
  ...
  #
  # def display_resource(appointments)
